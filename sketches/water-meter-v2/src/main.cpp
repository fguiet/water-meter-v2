...
Water meter v2
   ...
   Author :             F. Guiet 
   Creation           : 20200627
   Last modification  : 20201229
  
  Version            : 1.0
  History            : 1.0 - First version          
                       2.0 - 20200830 - Remove all delay statement...
                       2.7 - 20201229 - Move from Arduino IDE to PlatformIO, improve battery voltage reading

  Note:

    Consumption : 36 mA

    Use "Arduino Pro or Pro Mini 328p, 3.3v, 8Mhz" to upload this sketch 

    Check config.h : #define CFG_eu868 1   
  
    See "config.h" in
      - F:\Personal\Projects\Programming\water-meter-v2\sketches\water-meter-v2\lib\arduino-lmic-1.5.1\src\lmic
